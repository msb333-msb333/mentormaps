...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    <head>
        ...
        <script type="text/javascript"
                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC-e-RpEFPKNX-hDqBs--zoYYCk2vmXdZg"></script>
        <script src="https://mentormaps.net/assets/js/util.js"></script>
        <script src="https://mentormaps.net/assets/js/main.js"></script>
        <script src="https://mentormaps.net/assets/js/jquery.scrollTo.min.js"></script>
        <!--[if lte IE 8]>
