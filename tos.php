...
<div id="page-wrapper">
    ...
    <article id="main">
        ...
        <section class="wrapper style5">
            <div class="inner">
                <section>
                    <h4>Mentor Maps: Terms of Service</h4>

                    <p><h5>TERMS OF SERVICE</h5>

                    <h5>----</h5>

                    <h5>OVERVIEW</h5>

                    This website is operated by FRC Team 3309 “The Friarbots”. Throughout the site, the terms “we”, “us”
                    and “our” refer to the Friarbots. FRC Team 3309 offers this website, including all information,
                    ...
                    By visiting our site and registering an account, you engage in our “Service” and agree to be bound
                    by the following terms and conditions (“Terms of Service”, “Terms”), including those additional
                    ...
                    <br/>
                    <h5>SECTION 4 - MODIFICATIONS TO THE SERVICE</h5>
                    ...
                    We have made every effort to display as accurately as possible the colors and images of our service
                    that appear on the website. We cannot guarantee that your computer monitor's display of any color
                    will be accurate.
                    ...
                    reserve the right to limit the quantities of any services that we offer. We reserve the right to
                    ...
                    <br/>
                    <h5>SECTION 6 - OPTIONAL TOOLS</h5>
                    ...
                    <br/>
                    <h5>SECTION 7 - THIRD-PARTY LINKS</h5>
                    ...
                    errors, inaccuracies or omissions. We reserve the right to correct any errors, inaccuracies or
                    omissions, and to change or update information if any information in the Service or on any related
                    website is inaccurate at any time without prior notice (including after you have registered your
                    account).

                    We undertake no obligation to update, amend or clarify information in the Service or on any related
                    website, including without limitation except as required by law. No specified update or refresh date
                    ...
                    service and all services delivered to you through the service are (except as expressly stated by us)
                    ...
                    In no case shall MentorMaps, our directors, officers, employees, affiliates, agents, contractors,
                    ...
                    You agree to indemnify, defend and hold harmless MentorMaps and our parent, subsidiaries,
                    ...
                    by and construed in accordance with the laws of 934 N. Keystone Dr, Anaheim, CA, 92801, United
                    States.
                    ...
                    Questions about the Terms of Service should be sent to us at info@team3309.org
