...
<div id="page-wrapper">
    ...
    <article class="wrapper style4" style="padding-top:0;text-align:center;">
        ...
        function echoTeamLegend(){
            echo '<div class="legend"><img class="paddedImgHolder" src="img/mentorflag.png"/>YOU | <img class="paddedImgHolder" src="img/redm.png"/>FRC | <img class="paddedImgHolder" src="img/whitem.png"/> FTC | <img class="paddedImgHolder" src="img/bluem.png"/>FLL | <img class="paddedImgHolder" src="img/orangem.png"/> VEX | <img class="paddedImgHolder" src="img/greenm.png"/> MULTI</div>';
        }

        function echoMentorLegend(){
            echo '<div class="legend"><img class="paddedImgHolder" src="img/mentorflag.png"/>YOU | <img class="paddedImgHolder" src="img/red.png"/>FRC | <img class="paddedImgHolder" src="img/white.png"/> FTC | <img class="paddedImgHolder" src="img/blue.png"/>FLL | <img class="paddedImgHolder" src="img/orange.png"/> VEX</div>';
        }
