            ...
            <header>
                <div id="profile-page" style="padding-left: 60px;" style="display:inline-block;">
                    ...
                    <div id="im-interested-wrapper" class="6u 12u$(small)">
                        ...
                        <label for="im-interested"> Add to my <a href="./dashboard.php">dashboard</a></label>
                        <script>
                            $(function () {
            ...
            <div style="display: inline-block;">
                ...
                <div style="float:right;width:50%;">
                    <div id="skill-info" style="padding-left: 90px;">
                        <?php if ($account_type == "MENTOR") { ?><h3>Mentor Skillset</h3><?php } else { ?><h3>Searching
                            For Help with</h3><?php } ?>
                    </div>
                    <div style="padding-left: 130px;">
                        <script>
                            <?php 
