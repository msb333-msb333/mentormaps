...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    <?php
    if (isset($_GET['error'])) {
        echo '<script>document.getElementById("wrong-password").innerHTML = "Wrong password <a href=\"./resetpassword.php\">reset?</a><br/><br/>";document.getElementById("wrong-password").setAttribute("style", "red;");</script>';
    }
    ?>
